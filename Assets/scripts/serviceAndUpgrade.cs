...
public class serviceAndUpgrade
{
    public static Dictionary<string, etcCardEffect> services = new Dictionary<string, etcCardEffect>()
    {
        ...
        ["ㅂㄹㄱ"] = new etcCardEffect(4, 0),
        ["ㄱㅂ"] = new etcCardEffect(0, 4),
        ["coin"] = new etcCardEffect(0, 1),
        ["ㅈㅂㅁㅅㅌ"] = new etcCardEffect(0, 7),
        ["ㅆㅇ"] = new etcCardEffect(4, 0),
        ["ㄸㄱㅇ"] = new etcCardEffect(0, 5), // 전설 서비스 패

    };

    public static Dictionary<string, string[]> titleCotent = new Dictionary<string, string[]>()
    {
        ["1"] = new string[] { "소나무", "1월에 해당하는 카드를 플레이하면 +4 배수" },
        ["2"] = new string[] { "매화", "2월에 해당하는 카드를 플레이하면 +4 배수" },
        ["3"] = new string[] { "벚꽃", "3월에 해당하는 카드를 플레이하면 +4 배수" },
        ["4"] = new string[] { "등나무", "4월에 해당하는 카드를 플레이하면 +4 배수" },
        ["5"] = new string[] { "난초", "5월에 해당하는 카드를 플레이하면 +4 배수" },
        ["6"] = new string[] { "모란", "6월에 해당하는 카드를 플레이하면 +4 배수" },
        ["7"] = new string[] { "싸리", "7월에 해당하는 카드를 플레이하면 +4 배수" },
        ["8"] = new string[] { "공산", "8월에 해당하는 카드를 플레이하면 +4 배수" },
        ["9"] = new string[] { "국화", "9월에 해당하는 카드를 플레이하면 +4 배수" },
        ["10"] = new string[] { "단풍", "10월에 해당하는 카드를 플레이하면 +4 배수" }, // 월 강화
        ["11r"] = new string[] { "비광", "광에 해당하는 카드를 플레이하면 +6 배수" },
        ["12r"] = new string[] { "봉황", "광에 해당하는 카드를 플레이하면 +4 배수" }, // 광
        ["an"] = new string[] { "동물애호자", "동물그림이 있는 카드를 플레이하면 +4배수" }, // 동물
        ["ㅈㄱ광땡"] = new string[] { "광땡", "광땡을 플레이 하면 +2배수\n광땡을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ끗"] = new string[] { "망통", "끗을 플레이 하면 +2배수\n끗을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ독사"] = new string[] { "독사", "독사 플레이 하면 +2배수\n독사를 플레이 할 때 마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ땡"] = new string[] { "장땡", "땡 플레이 하면 +2배수\n땡을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ구삥"] = new string[] { "구삥", "구삥 플레이 하면 +2배수\n구삥을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ장삥"] = new string[] { "장삥", "장삥 플레이 하면 +2배수\n장삥을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ세륙"] = new string[] { "세륙", "세륙 플레이 하면 +2배수\n세륙을 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ알리"] = new string[] { "알리", "알리 플레이 하면 +2배수\n알리를 플레이 할 때마다 +1배수 (최대 +6배수)" },
        ["ㅈㄱ장사"] = new string[] { "장사", "장사 플레이 하면 +2배수\n장사를 플레이 할 때마다 +1배수 (최대 +6배수)" }, // 족보강화 (성장형)
        ["ㅂㄹㄱ"] = new string[] { "쓰레기통", "버리기 할 때 마다 +4 칩" }, // 성장형
        ["ㄱㅂ"] = new string[] { "꽃놀이패", "플레이할때 +4 배수" },
        ["coin"] = new string[] { "저축", "코인을 5개 보유 할 때마다 +1 배수 (최대 +5 배수)" },
        ["ㅈㅂㅁㅅㅌ"] = new string[] { "족보마스터", "모든 족보를 2회씩 플레이하면 x7 배수" },
        ...
        ["2g"] = new string[] { "햇빛", "플레이할때 +1 배수" }, // 원래 은, 금 한개씩인데 파일이름 처리 때문에
        ["ty"] = new string[] { "아무것도 없는 카드", "족보에 포함안되고, 덱 또는 패에 가지고 있으면 +30 칩" }, //강화카드
    };
